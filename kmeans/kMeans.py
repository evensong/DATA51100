...
def main():
    ...
    while point_assignments != old_point_assignments:
        ...
        assignClusters(data, clusters, centroids, point_assignments)
    ...
    for key, value in point_assignments.items(): print('Point ', key, ' in cluster ', value)
